...
static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_EVoxelType(EVoxelType_StaticEnum, TEXT("/Script/InfiniteVoxelWorld"), TEXT("EVoxelType"), false, nullptr, nullptr);
	...
	UClass* Z_Construct_UClass_AVoxelTerrainActor()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				UProperty* NewProp_ChunkIDs_Inner = new(EC_InternalUseOnlyConstructor, NewProp_ChunkIDs, TEXT("ChunkIDs"), RF_Public|RF_Transient|RF_MarkAsNative) UEnumProperty(FObjectInitializer(), EC_CppProperty, 0, 0x0000000000000000, Z_Construct_UEnum_InfiniteVoxelWorld_EVoxelType());
				UProperty* NewProp_ChunkIDs_Inner_Underlying = new(EC_InternalUseOnlyConstructor, NewProp_ChunkIDs_Inner, TEXT("UnderlyingType"), RF_Public|RF_Transient|RF_MarkAsNative) UByteProperty(FObjectInitializer(), EC_CppProperty, 0, 0x0000000000000000);
	...
	IMPLEMENT_CLASS(AVoxelTerrainActor, 3340611744);
